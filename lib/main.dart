    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const ListTile(
            title: Text("Planta Selecionada", style: TextStyle(fontSize: 14)),
            subtitle: Text(
              "Samambaia (Solo Úmido)",
          ...
          ListTile(
            title: const Text("Umidade Mínima", style: TextStyle(fontSize: 14)),
            subtitle: const Text("60%"),
            trailing: Switch(value: true, onChanged: (v) {}),
          ),
          ListTile(
            title: const Text("Umidade Máxima", style: TextStyle(fontSize: 14)),
